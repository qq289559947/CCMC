...
-(id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier{
    if (self = [super initWithStyle:style reuseIdentifier:reuseIdentifier]) {
        ...
        //word
        KWJLableButton *wordButton = [KWJLableButton labelButtonWithImage:@"word"];
        ...
        //ppt
        KWJLableButton *pptButton = [KWJLableButton labelButtonWithImage:@"ppt"];
        ...
        //voideo
        KWJLableButton *voideoButton = [KWJLableButton labelButtonWithImage:@"video"];
